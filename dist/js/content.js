...
class Filter {
    ...
    getDateRange() {
        if (_Settings__WEBPACK_IMPORTED_MODULE_0__["form"].postDate.checked) {
            const date = new Date(_Settings__WEBPACK_IMPORTED_MODULE_0__["form"].postDateInput.value).getTime();
            if (isNaN(date)) {
                _EVT__WEBPACK_IMPORTED_MODULE_2__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_2__["EVT"].events.crawlError);
    ...
    checkPostDate(date) {
        ...
        const flag = parseInt(_Settings__WEBPACK_IMPORTED_MODULE_0__["form"].postRange.value);
        const setDate = new Date(_Settings__WEBPACK_IMPORTED_MODULE_0__["form"].postDateInput.value);
...
const formHtml = `<form class="settingForm">
      ...
      <span class="beautify_radio"></span>
      <label for="postRange2">  ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_早于')}&nbsp; </label>
      <input type="radio" name="postRange" id="postRange1" class="need_beautify radio" value="1">
      <span class="beautify_radio"></span>
      <label for="postRange1">  ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_晚于')}&nbsp; </label>
...
const langText = {
    ...
    _视频: ['视频', 'ビデオ', 'Video', '視頻'],
    _音乐: ['音频', '音声', 'Audio', '音頻'],
    _压缩文件: ['压缩文件', '圧縮ファイル', 'Compressed file', '壓縮檔案'],
