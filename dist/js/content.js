      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        const langText = {
          ...
          _抓取结果为零: [
            ...
            '擷取完畢，但沒有找到符合篩選條件的檔案。',
            '탐색이 완료되었지만 필터 조건과 일치하는 파일을 찾지 못했습니다.',
          ],
          _当前任务尚未完成2: [
            '当前任务尚未完成，请等待完成后再下载。',
          ...
          _设置id范围提示: [
            ...
            '1개의 투고문 ID를 입력하면 그보다 새로운 혹은 오래된 투고문을 한꺼번에 다운로드 받을 수 있습니다.',
          ],
