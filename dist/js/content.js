...
const langText = {
    ...
    _PS文件: ['psd', 'psd', 'psd', 'psd'],
    _投稿类型: ['投稿类型', '記事タイプ', 'Article type', '投稿類型'],
    _免费投稿: ['免费投稿', '無料記事', 'Free article', '免費投稿'],
    _付费投稿: ['付费投稿', '有償記事', 'Paid article', '付費投稿'],
    _设置价格范围: ['设置价格范围', '価格帯を設定', 'Set price range', '設置價格範圍'],
    _保存投稿中的外部链接: ['保存投稿中的外部链接', '記事に外部リンクを保存する', 'Save external links in articles', '存儲投稿中的外部鏈接'],
    _抓取文件数量: ['已获取 {} 个文件', '{} ファイルを取得', '{} Files acquired', '已取得 {} 個檔案'],
    ...
    _抓取该用户的投稿: ['抓取该用户的投稿', 'ユーザーの記事をクロールする', 'Crawl this user\'s articles', '抓取該用戶的投稿'],
    _抓取该tag的投稿: ['抓取该 tag 的投稿', 'このタグで記事をクロールする', 'Crawl articles with this tag', '抓取該 tag 的投稿'],
    _抓取这篇投稿: ['抓取这篇投稿', 'この記事をつかむ', 'Crawl this article', '抓取這篇投稿'],
    _抓取商品的封面图: ['抓取商品的封面图', '製品のカバー画像をつかむ', 'Crawl the cover image of the product', '抓取商品的封面圖'],
    ...
    _命名标记name: ['文件在投稿里的文件名', '記事内のファイル名', 'File name in the article', '檔案在投稿裡的名称'],
    _命名标记ext: ['文件的扩展名', 'ファイル拡張子', 'File extension', '檔案的擴展名'],
    _命名标记提醒: [
