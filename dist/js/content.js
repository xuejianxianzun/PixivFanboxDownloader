/******/ ;(function (modules) {
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitHomePage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_3__[
          ...
          async getPostList() {
            const data = await _API__WEBPACK_IMPORTED_MODULE_4__[
              'API'
            ].getlistSupporting(300)
            console.log(data)
          }
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _Settings__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ./Settings */ './src/ts/modules/Settings.ts'
        )
        ...
        class InitPageBase {
          ...
          init() {
            ...
            this.initElse()
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_7__['EVT'].events.destroy,
              () => {
                this.destroy()
              }
            )
          ...
          getWantPageError() {
            _EVT__WEBPACK_IMPORTED_MODULE_7__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_7__['EVT'].events.crawlError
            )
          ...
          checkWantPageInput(crawlPartTip, crawlAllTip) {
            const temp = parseInt(
              _Settings__WEBPACK_IMPORTED_MODULE_8__['form'].setWantPage.value
            )
            // 如果比 1 小，并且不是 -1，则不通过
            ...
            if (temp >= 1) {
              _Log__WEBPACK_IMPORTED_MODULE_6__['log'].warning(
          ...
          async readyCrawl() {
            if (
              !_Store__WEBPACK_IMPORTED_MODULE_5__['store'].states.allowWork
            ) {
              window.alert(
                _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
                  '_当前任务尚未完成2'
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_7__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_7__['EVT'].events.crawlStart
            )
            _Log__WEBPACK_IMPORTED_MODULE_6__['log'].clear()
            _Log__WEBPACK_IMPORTED_MODULE_6__['log'].success(
          ...
          getIdListFinished() {
            ...
            if (
              _Store__WEBPACK_IMPORTED_MODULE_5__['store'].PostIdList.length ===
              0
            ) {
          ...
          async getPostData(id) {
            id =
              id ||
              _Store__WEBPACK_IMPORTED_MODULE_5__['store'].PostIdList.shift()
            let data
            try {
              // 发起请求
              data = await _API__WEBPACK_IMPORTED_MODULE_4__['API'].getPost(
                '867418'
              )
            } catch (error) {
            ...
            // 检查通过
            if (
              _Filter__WEBPACK_IMPORTED_MODULE_3__['filter'].check(filterOpt)
            ) {
          ...
          afterGetWorksData() {
            if (
              _Store__WEBPACK_IMPORTED_MODULE_5__['store'].PostIdList.length > 0
            ) {
              // 如果存在下一个作品，则
              this.getPostData()
            } else {
          ...
          noResult() {
            _EVT__WEBPACK_IMPORTED_MODULE_7__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_7__['EVT'].events.crawlEmpty
            )
  ...
  <div class="tabsContnet">
    <div class="con">
      ...
      <label for="fileType1"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__[
        'lang'
      ].transl('_图片')}&nbsp;</label>
      
      <input type="checkbox" name="music" id="fileType2" class="need_beautify checkbox_common" checked>
      <span class="beautify_checkbox"></span>
      <label for="fileType2"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__[
        'lang'
      ].transl('_音乐')}&nbsp;</label>
  ...
  \************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _SaveSettings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./SaveSettings */ './src/ts/modules/SaveSettings.ts'
        )
        /* harmony import */ var _SettingHTML__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
        ...
        class Settings {
          constructor() {
            ...
            this.form = _DOM__WEBPACK_IMPORTED_MODULE_1__['DOM'].useSlot(
              'form',
              _SettingHTML__WEBPACK_IMPORTED_MODULE_5__['default']
            )
            ...
            this.bindEvents()
            new _SaveSettings__WEBPACK_IMPORTED_MODULE_4__['SaveSettings'](
              this.form
            )
