/******/ ;(function (modules) {
  ...
  \***************************************/
      ...
      <a class="has_tip centerWrap_top_btn wiki_url" data-tip="${_Lang__WEBPACK_IMPORTED_MODULE_0__[
        ...
        '_wiki'
      )}" href="https://github.com/xuejianxianzun/PixivFanboxDownloader/wiki" target="_blank">
      ...
      <a class="wiki2" href="https://github.com/xuejianxianzun/PixivFanboxDownloader/wiki" target="_blank"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__[
        'lang'
      ].transl('_wiki')}</a>
            ...
            chrome.runtime.onMessage.addListener((msg) => {
              ...
              if (msg.msg === 'downloaded') {
                ...
                _Log__WEBPACK_IMPORTED_MODULE_3__['log'].error(
                  `${msg.data.url} download error! code: ${msg.err}.`
                )
                _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].fire(
    ...
    <span class="down_status blue"><span>${_Lang__WEBPACK_IMPORTED_MODULE_4__[
      'lang'
          ...
          showURLs() {
            ...
            let result = ''
            for (const now of _Store__WEBPACK_IMPORTED_MODULE_2__['store']
              .result) {
              result += now.url + '<br>'
            }
            _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].fire(
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitPageBase {
          ...
          init() {
            ...
            this.initElse()
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_6__['EVT'].events.destroy,
              () => {
                this.destroy()
              }
            )
  ...
  <div class="tabsContnet">
    <div class="con">
      ...
      <span class="beautify_checkbox"></span>
      <label for="fileType6"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__[
        'lang'
      ].transl('_其他')}&nbsp;</label>
      </p>
