...
/* harmony import */ var _TitleBar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TitleBar */ "./src/ts/modules/TitleBar.ts");
/* harmony import */ var _FileName__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./FileName */ "./src/ts/modules/FileName.ts");
/* harmony import */ var _ProgressBar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ProgressBar */ "./src/ts/modules/ProgressBar.ts");
// 下载文件，并发送给浏览器下载
...
class Download {
    ...
    listenEvents() {
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].events.downloadSucccess, (event) => {
    ...
    setProgressBar(loaded, total) {
        _ProgressBar__WEBPACK_IMPORTED_MODULE_3__["progressBar"].setProgress(this.progressBarIndex, {
            name: this.fileName,
            loaded: loaded,
            total: total,
        });
    ...
    download(arg) {
        ...
        // 获取文件名
        this.fileName = _FileName__WEBPACK_IMPORTED_MODULE_2__["fileName"].getFileName(arg.data);
        // 重设当前下载栏的信息
...
class DownloadControl {
    ...
    <button class="previewFileName" type="button" style="background:${_Colors__WEBPACK_IMPORTED_MODULE_6__["Colors"].green};"> ${_Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_预览文件名')}</button>
    </div>
...
class FileName {
    ...
    getFileName(data) {
        ...
        // 为空时使用预设的命名规则
        result = result || _Store__WEBPACK_IMPORTED_MODULE_2__["store"].defaultFileName;
        // 配置所有命名标记
        const cfg = {
            '{postid}': {
                value: data.postId,
            ...
            '{date}': {
                value: _DateFormat__WEBPACK_IMPORTED_MODULE_4__["DateFormat"].format(data.date, _Settings__WEBPACK_IMPORTED_MODULE_1__["form"].dateFormat.value),
                safe: false,
            },
            '{task_date}': {
                value: _DateFormat__WEBPACK_IMPORTED_MODULE_4__["DateFormat"].format(_Store__WEBPACK_IMPORTED_MODULE_2__["store"].crawlCompleteTime, _Settings__WEBPACK_IMPORTED_MODULE_1__["form"].dateFormat.value),
                prefix: '',
                safe: false,
            },
            '{fee}': {
...
class Filter {
    ...
    // 获取 id 范围设置
    getIdRange() {
        if (_Settings__WEBPACK_IMPORTED_MODULE_0__["form"].idRangeSwitch.checked) {
    ...
    getDateRange() {
        if (!_Settings__WEBPACK_IMPORTED_MODULE_0__["form"].postDate.checked ||
    ...
    checkFileType(ext) {
        ...
        for (const [key, value] of Object.entries(_Store__WEBPACK_IMPORTED_MODULE_3__["store"].fileType)) {
    ...
    checkIdRange(id) {
        ...
        const flag = parseInt(_Settings__WEBPACK_IMPORTED_MODULE_0__["form"].idRange.value);
...
/* harmony import */ var _TitleBar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./TitleBar */ "./src/ts/modules/TitleBar.ts");
/* harmony import */ var _SaveData__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./SaveData */ "./src/ts/modules/SaveData.ts");
// 初始化抓取页面的流程
...
class InitPageBase {
    ...
    init() {
        ...
        this.appendElseEl();
        this.initElse();
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_5__["EVT"].events.destroy, () => {
            this.destroy();
        });
    }
    // 各个子类私有的初始化内容
    ...
    afterFetchPost(data) {
        _SaveData__WEBPACK_IMPORTED_MODULE_7__["saveData"].receive(data.body);
        this.crawlFinished();
    }
    // 抓取完毕
    crawlFinished() {
...
class InitPostPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_3__["InitPageBase"] {
    ...
    async FetchPostList() { }
    async fetchPost() {
        const data = await _API__WEBPACK_IMPORTED_MODULE_4__["API"].getPost(_API__WEBPACK_IMPORTED_MODULE_4__["API"].getURLPathField('posts'));
...
class InitTagPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_3__["InitPageBase"] {
    ...
    async FetchPostList() {
        ...
        if (this.nextUrl) {
            ...
            data = await _API__WEBPACK_IMPORTED_MODULE_4__["API"].getTagPostListByUser(await _API__WEBPACK_IMPORTED_MODULE_4__["API"].getUserId(_API__WEBPACK_IMPORTED_MODULE_4__["API"].getCreatorId(location.href)), _API__WEBPACK_IMPORTED_MODULE_4__["API"].getURLPathField('tags'));
        }
        this.afterFetchPostList(data);
    }
    async fetchPost() { }
...
class SaveData {
    ...
    parsePost(data) {
        ...
        if (_Settings__WEBPACK_IMPORTED_MODULE_2__["form"].savePostCover.checked) {
        ...
        if (data.type !== 'article') {
            ...
            if (text) {
                ...
                // 保存文章正文里的文字
                if (_Settings__WEBPACK_IMPORTED_MODULE_2__["form"].saveText.checked) {
    ...
    getTextLinks(text) {
        const links = [];
        if (!_Settings__WEBPACK_IMPORTED_MODULE_2__["form"].saveLink.checked) {
            return links;
        }
...
class SaveSettings {
    constructor(form) {
        ...
        this.optionDefault = {
            ...
            saveLink: true,
            saveText: false,
            userSetName: _Store__WEBPACK_IMPORTED_MODULE_1__["store"].defaultFileName,
            quietDownload: true,
            downloadThread: 3,
...
const formHtml = `<form class="settingForm">
      ...
      <label for="fileType1" class="has_tip" data-tip="${_Store__WEBPACK_IMPORTED_MODULE_1__["store"].fileType.image.join(',')}"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_图片')}&nbsp;</label>
      
      <input type="checkbox" name="music" id="fileType2" class="need_beautify checkbox_common" checked>
      <span class="beautify_checkbox"></span>
      <label for="fileType2" class="has_tip" data-tip="${_Store__WEBPACK_IMPORTED_MODULE_1__["store"].fileType.music.join(',')}"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_音乐')}&nbsp;</label>

      <input type="checkbox" name="video" id="fileType3" class="need_beautify checkbox_common" checked>
      <span class="beautify_checkbox"></span>
      <label for="fileType3" class="has_tip" data-tip="${_Store__WEBPACK_IMPORTED_MODULE_1__["store"].fileType.video.join(',')}"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_视频')}&nbsp;</label>
      
      <input type="checkbox" name="compressed" id="fileType4" class="need_beautify checkbox_common" checked>
      <span class="beautify_checkbox"></span>
      <label for="fileType4" class="has_tip" data-tip="${_Store__WEBPACK_IMPORTED_MODULE_1__["store"].fileType.compressed.join(',')}"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_压缩文件')}&nbsp;</label>
      
      <input type="checkbox" name="ps" id="fileType5" class="need_beautify checkbox_common" checked>
      <span class="beautify_checkbox"></span>
      <label for="fileType5" class="has_tip" data-tip="${_Store__WEBPACK_IMPORTED_MODULE_1__["store"].fileType.ps.join(',')}"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_PS文件')}&nbsp;</label>

      <input type="checkbox" name="other" id="fileType6" class="need_beautify checkbox_common" checked>
      <span class="beautify_checkbox"></span>
      <label for="fileType6" class="has_tip" data-tip="${_Store__WEBPACK_IMPORTED_MODULE_1__["store"].fileType.other.join(',')}"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_其他')}&nbsp;</label>
      </p>
      ...
      <p class="option" data-no="9">
      <span class="has_tip settingNameStyle1" data-tip="${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_设置id范围提示')}">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_设置id范围')}&nbsp;&nbsp; 
      ...
      <span class="settingNameStyle1">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_保存投稿中的封面图片')}&nbsp;&nbsp; 
      </span>
      ...
      <span class="settingNameStyle1">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_保存投稿中的文字')}&nbsp;&nbsp; 
      </span>
    ...
    <p class="option" data-no="13">
      ...
      <input type="text" name="userSetName" class="setinput_style1 blue fileNameRule" value=${_Store__WEBPACK_IMPORTED_MODULE_1__["store"].defaultFileName}>
      &nbsp;
...
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _SaveSettings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SaveSettings */ "./src/ts/modules/SaveSettings.ts");
/* harmony import */ var _SettingHTML__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SettingHTML */ "./src/ts/modules/SettingHTML.ts");
...
class Settings {
    constructor() {
        ...
        this.form = _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].useSlot('form', _SettingHTML__WEBPACK_IMPORTED_MODULE_3__["default"]);
        ...
        this.bindEvents();
        new _SaveSettings__WEBPACK_IMPORTED_MODULE_2__["SaveSettings"](this.form);
    ...
    listenPageSwitch() {
        ...
        ['pushState', 'popstate', 'replaceState'].forEach((item) => {
            window.addEventListener(item, () => {
                _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].events.pageSwitch);
            });
        });
    }
}
